...
public enum ExceptionEnumeration {
    ...
    /******************************************** 收货地址管理模块 start ******************************************************/
    ShippingAddressIsDeleted(1002001, "收货地址已被删除"),
    /******************************************** 收货地址管理模块 end ******************************************************/

    /******************************************** 商品模块 start ******************************************************/
    CommodityInventoryNotEnough(1009001, "该商品库存量不足"),
    CommodityIsNotFound(1009003,"找不到该商品"),
    /******************************************** 商品模块 end ******************************************************/
    /******************************************** 订单管理模块 start ******************************************************/
    OrderIsNotFound(1010001, "找不到该订单"),
    OrderUpdateFailed(1010002, "订单更新失败")
    /******************************************** 订单管理模块 end ******************************************************/
